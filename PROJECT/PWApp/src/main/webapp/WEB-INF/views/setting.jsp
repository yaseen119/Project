...
<body>
	<div style="border: 2px solid black; background-color: aquamarine; height: 500px; width: 600px; margin-left: 400px; margin-top: 50px;">
		<div id="div1">
			<h3>WELCOME TO PAYMENT APPLICATION SETTING</h3>
		</div>
		<div id="div2">
			<span><a href="home1">HOME</a></span> 
			<span><a href="displayUsers1">DISPLAY USERS</a></span>
		</div>
		<div style="border: 2px solid black; height: 300px; width: 450px; margin-left: 80px; margin-top: 50px;">
			...
			<div style="display: flex;justify-content: space-around;margin-left: 30px;">
				<h1>THIS IS PAYMENT APPLICATION SETTING PAGE</h1>
			</div>
		</div>
	</div>
</body>
