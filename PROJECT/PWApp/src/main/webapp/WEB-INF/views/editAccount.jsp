...
<body>
	<div style="border: 2px solid black; background-color: yellow; height: 500px; width: 600px; margin-left: 400px; margin-top: 50px;">
		<br> <br>
		<div>
			<h1 style="display: flex; justify-content: center;">EDIT ACCOUNT</h1>
		</div>
		<div style="height: 300px; width: 450px; margin-left: 150px;">
			<form:form action="updateAccount1" modelAttribute="edit">
				<table cellspacing="0px">
					...
					<tr>
						<td colspan="2" align="center"><form:button>Update</form:button></td>
					</tr>
				</table>
			</form:form>
		</div>
